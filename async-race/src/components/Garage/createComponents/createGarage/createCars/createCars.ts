...
export function createCar(name: string, id: number, color: string) {
  ...
  car.innerHTML = `
    ...
    <div class = "pictures">
      <svg class = "car-img car-img-${id}" xmlns="http://www.w3.org/2000/svg" fill = ${color} xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="mdi-car-pickup" width="24" height="24" viewBox="0 0 24 24">
